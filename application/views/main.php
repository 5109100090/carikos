...
<title>CariKos Online</title>
	<script type="text/javascript" src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/js/jquery-1.6.2.min.js"></script>
	<script type="text/javascript" src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/js/jquery-ui-1.8.14.custom.min.js"></script>

	<script type="text/javascript" src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/js/slider/jquery_002.js"></script>
	<script type="text/javascript" src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/js/slider/jquery.js"></script>
	<script type="text/javascript" src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/js/slider/jquery_003.js"></script>
	<script type="text/javascript" src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/js/slider/init.js"></script>
	<script type="text/javascript" src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/js/slider/easySlider1.5.js"></script>
	<script src="http://maps.google.com/maps/api/js?sensor=true" type="text/javascript"></script>
    <script type="text/javascript" src="http://code.google.com/apis/gears/gears_init.js"></script>
	
	<link href="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/css/base.css" type="text/css" rel="stylesheet">
	<link href="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/css/style_scrollpage.css" type="text/css" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/css/jquery-ui-1.8.14.custom.css">
	<!-- include Cycle plugin -->
	<script type="text/javascript" src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/js/jquery.cycle.all.2.74.js"></script>
...
<script type="text/javascript">	
	...
	$(document).ready(function(){
		...
		var base_url = 'https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/';
...
<div class="layer_login_dll">
	<center>
		<div class="layer1">
			<div class="header11">
				<center><a href="<?php echo base_url() ?>"><img src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/images/template/home/logocarikos.png"></a><center>
			</div>
			<div class="content11">
					...
					<div class="showslide">	
							<center>
								<div class="slideshow2">
									<img src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/images/r1.png">
									<img src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/images/r2.png">
								</div>
							</center>
...
Anda dapat mencari kos di website ini berdasdarkan kategori yang ingin anda cari atau juga bisa mencari berdasarkan wilayah yang dekat dengan daerah yang anda inginkan.
					...
					<div class="isi_contact">
						<div class="boxprofil">
							...
							<div class="photo">
								<img src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/images/profile/sindung.png">
							</div>
							<div class="kontak">
								<li>Anggota 1</li> 
						...
						<div class="boxprofil">
							...
							<div class="photo">
								<img src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/images/profile/rizky.png">
							</div>
							<div class="kontak">
								<li>Anggota 2</li> 
						...
						<div class="boxprofil">
							...
							<div class="photo">
								<img src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/images/profile/buyuhana.png">
							</div>
							<div class="kontak">
...
<!--start of page search_home----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->			
				<li class="search_home">
					...
					<div class="container"> 
						<div class="header"><center><a href="<?php echo base_url() ?>"><img src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/images/template/home/logocarikos.png"></a><center></div>
						<div class="slide">
							<center>
								<div class="slideshow">
									<img src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/images/s1.png">
									<img src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/images/s2.png">
									<img src="https://raw.githubusercontent.com/itsnotrisky/carikos-static/gh-pages/images/s1.png">
								</div>
							</center>
						</div>
