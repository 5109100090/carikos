	...
	<div id="content">
		<div id="kotak_slider">
			...
			<!----------------------start slide show------------------------------>
				...
				<div class="kotak_slide">
					<h1>Mengapa Harus CariKos-Online ??</h1>
					<p>Karena CariKos Online merupakan Website yang di konsep untuk membantu dan mempermudah anda dalam mencari kos-kosan yang cocok dengan yang anda inginkan. 
						Tentunya dengan website ini anda dapat menemukan tempat kos dengan cepat, mudah, dan tepat.    </p>
				</div>
			<!----------------------end slide show------------------------------>
			</div>
		</div>
